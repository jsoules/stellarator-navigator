...
// This file imported with modifications from flatironinstitute MCMCMonitor

// Hopefully fixed--by adding the ReactFragment custom typing.
// Note this fix also changes the below reference to Draggable1 back to Draggable.
...
const Splitter: FunctionComponent<PropsWithChildren<Props>> = (props) => {
    ...
    if (!Array.isArray(props.children)) {
        child1 = props.children as unknown as ReactElement
        child2 = null
    }
    else {
            ...
            </div>
            {
                adjustable && (
                    <Draggable
                        ...
                        nodeRef={noderef}
                    >
                        <div ref={noderef} style={{...styleGripOuter, position: 'absolute'}}>
